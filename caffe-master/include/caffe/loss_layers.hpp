...
class TripletLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  ...
  Blob<Dtype> diff_pos;
  Blob<Dtype> diff_neg;
  Blob<Dtype> diff_neg_1;
  Blob<Dtype> diff_neg_2;
  Blob<Dtype> dist_sq_;  // cached for backward pass
  Blob<Dtype> dist_sq_pos;
  Blob<Dtype> dist_sq_neg;
  Blob<Dtype> dist_sq_neg_1;
  Blob<Dtype> dist_sq_neg_2;
  Blob<Dtype> diff_sq_;  // tmp storage for gpu forward pass
  Blob<Dtype> diff_sq_pos;
  Blob<Dtype> diff_sq_neg;
  Blob<Dtype> diff_sq_neg_1;
  Blob<Dtype> diff_sq_neg_2;
  Blob<Dtype> summer_vec_;  // tmp storage for gpu forward pass
  Blob<Dtype> ind_ori;
};
