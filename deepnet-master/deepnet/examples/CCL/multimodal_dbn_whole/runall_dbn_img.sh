...
runDir=${deepnet}/examples/CCL/multimodal_dbn_whole
prefix=${deepnet}/examples/CCL/multimodal_dbn_whole/data/
...
#then
 # echo Computing mean / variance
  python ${deepnet}/compute_data_stats.py ${prefix}/wikipedia.pbtxt \
    ${prefix}/../../feature/imgstats_whole.npz image_unlabelled || exit 1
#fi
...
#(
  ...
  python ${trainer} ${runDir}/models/image_rbm1.pbtxt \
    ${runDir}/trainers/dbn/train_CD_image_layer1.pbtxt ${runDir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/image_rbm1_LAST \
    ${runDir}/trainers/dbn/train_CD_image_layer1.pbtxt image_hidden1 \
...
## IMAGE LAYER - 2.
  ...
  python ${trainer} ${runDir}/models/image_rbm2.pbtxt \
    ${runDir}/trainers/dbn/train_CD_image_layer2.pbtxt ${runDir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/image_rbm2_LAST \
    ${runDir}/trainers/dbn/train_CD_image_layer2.pbtxt image_hidden2 \
...
#    ${prefix}/wikipedia.pbtxt ${gpu_mem} ${main_mem} || exit 1
#  python sample_text.py models/multimodal_dbn.pbtxt \
#    trainers/dbn/train_CD_text_layer1.pbtxt ${data_output_dir}/generated_image \
#    ${prefix}/wikipedia.pbtxt ${gpu_mem} ${main_mem} || exit 1
#fi
