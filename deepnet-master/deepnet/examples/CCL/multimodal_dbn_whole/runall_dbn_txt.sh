...
#    ${prefix}/imgstats.npz image_unlabelled || exit 1
#fi
...
## TEXT LAYER - 1.
  ...
  python ${trainer} ${runDir}/models/text_rbm1.pbtxt \
    ${runDir}/trainers/dbn/train_CD_text_layer1.pbtxt ${runDir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/text_rbm1_LAST \
    ${runDir}/trainers/dbn/train_CD_text_layer1.pbtxt text_hidden1 \
...
## TEXT LAYER - 2.
  ...
  python ${trainer} ${runDir}/models/text_rbm2.pbtxt \
    ${runDir}/trainers/dbn/train_CD_text_layer2.pbtxt ${runDir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/text_rbm2_LAST \
    ${runDir}/trainers/dbn/train_CD_text_layer2.pbtxt text_hidden2 \
