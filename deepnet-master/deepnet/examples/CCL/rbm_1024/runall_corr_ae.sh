...
model_output_dir=rbm_1024/data/ae_models
data_output_dir=rbm_1024/data/ae_reps

models_dir=rbm_1024/ae_models
trainers_dir=rbm_1024/ae_trainers
...
do
  ...
  if ${clobber} || [ ! -e ${model_output_dir}/corr_ae_LAST ]; then
    ...
    python ${trainer} ${models_dir}/corr_ae.pbtxt \
      ${trainers_dir}/train_ae_layer.pbtxt rbm_1024/eval.pbtxt || exit 1
